...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        default: 'bg-neutral-90 text-neutral-0 shadow-sm hover:bg-neutral-80',
        destructive: 'bg-destructive text-destructive-foreground shadow-sm hover:bg-error-hover',
        outline: 'border border-border bg-card shadow-sm hover:bg-muted hover:text-foreground',
        secondary: 'bg-muted text-foreground shadow-sm hover:bg-neutral-5',

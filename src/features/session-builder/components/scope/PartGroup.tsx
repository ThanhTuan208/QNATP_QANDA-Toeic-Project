          ...
          return (
            ...
            >
              <span className='relative h-7 w-7 shrink-0 rounded-lg bg-green-teal-10 shadow-[inset_-1px_1px_4px_0px_#f0fffe,inset_1px_-1px_4px_0px_#00bdb0,-1px_2px_4px_0px_#00bdb0]'>
                ...
                <svg fill='#00756d' viewBox='-3.2 -3.2 38.4 38.4' xmlns='http://www.w3.org/2000/svg' className='pointer-events-none absolute left-1/2 top-1/2 h-4 w-4 -translate-x-1/2 -translate-y-1/2 opacity-0 peer-checked:opacity-100'>
                  <path d='M5 16.577l2.194-2.195 5.486 5.484L24.804 7.743 27 9.937l-14.32 14.32z'></path>
                </svg>
                <svg fill='#00756d' viewBox='0 0 1024 1024' xmlns='http://www.w3.org/2000/svg' className='pointer-events-none absolute left-1/2 top-1/2 h-4 w-4 -translate-x-1/2 -translate-y-1/2 peer-checked:opacity-0'>

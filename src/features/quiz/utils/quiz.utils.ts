...
const SAMPLE_QUESTIONS: Record<string, string> = {
  comparison: 'This year\'s sales figures are ______ than last year\'s, reflecting our successful market expansion.',
  'word-form': 'The new candidate demonstrated excellent analytical ______ during the interview process.',
  vocabulary: 'The board of directors voted to ______ the merger proposal at the next shareholder meeting.',
  'verb-tense': 'The quarterly financial report ______ by the accounting department before the deadline.',
  preposition: 'All employees are encouraged to participate ______ the professional development workshop.',
  conjunction: '______ the company faced budget constraints, the project was still completed on schedule.',
  ...
  'relative-clause': 'The marketing director ______ was hired last quarter has already improved our brand presence.',
...
const TYPE_EXPLANATIONS: Record<string, string> = {
  comparison: 'So sánh: dùng tính từ/trạng từ ở dạng so sánh hơn (more/less + adj/adv + than) hoặc so sánh nhất (the + most/least + adj/adv).',
  'word-form': 'Loại từ: chọn dạng đúng của từ gốc (V, N, Adj, Adv) — thường có cùng gốc nhưng khác hậu tố (-tion, -ive, -ly, -ment).',
  vocabulary: 'Từ vựng: chọn từ/cụm từ đúng nghĩa trong ngữ cảnh — thường là collocations (launch a product, attend a meeting, file a report).',
  'verb-tense': 'Thì: chọn thì đúng dựa vào trạng từ thời gian (now, last week, by next month, since 2020) và ngữ cảnh.',
  preposition: 'Giới từ: chọn giới từ đúng đi với động từ/tính từ/danh từ (depend on, responsible for, participation in, interest in).',
  conjunction: 'Liên từ: chọn từ nối đúng (however, therefore, moreover, nevertheless, in addition) dựa vào quan hệ logic giữa 2 mệnh đề.',
  participle: 'Phân từ: chọn V-ing (chủ động) hoặc V3/ed (bị động) — xác định danh từ được bổ nghĩa là chủ thể hay đối tượng của hành động.',
  voice: 'Câu bị động/Causative: chọn dạng bị động (be + V3/ed) hoặc cấu trúc have/get something done.',
  'relative-clause': 'Mệnh đề quan hệ: chọn who/whom/which/that/whose dựa vào danh từ đứng trước (người/vật) và vai trò trong mệnh đề (S/O).',
  agreement: 'Hòa hợp S-V: chọn động từ chia đúng với chủ ngữ — chú ý each/every/either/neither, as well as/together with, a number of/the number of.',
}
    ...
    [
      {
        ...
        difficulty: 'medium',
        options: [
          { text: 'Đáp án đúng', isCorrect: true, rationale: 'Giải thích bằng tiếng Việt tại sao đáp án này đúng' },
          { text: 'Đáp án sai A', isCorrect: false, rationale: 'Giải thích bằng tiếng Việt tại sao đáp án này sai' },
          { text: 'Đáp án sai B', isCorrect: false, rationale: 'Giải thích bằng tiếng Việt tại sao đáp án này sai' },
          { text: 'Đáp án sai C', isCorrect: false, rationale: 'Giải thích bằng tiếng Việt tại sao đáp án này sai' },
        ],

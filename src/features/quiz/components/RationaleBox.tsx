    ...
    <div className='space-y-4'>
      ...
      >
        <div className='mb-3 flex items-center gap-2'>
          {isCorrect ? (
            <>
              <CheckCircle2 className='h-6 w-6 text-green-teal' />
              <span className='text-lg font-semibold text-green-dark'>Correct!</span>
            </>
          ) : (
            <>
      ...
      {hasNext && (
        <button
          type='button'
          onClick={onNext}
          className='flex w-full items-center justify-center gap-2 rounded-xl bg-neutral-90 px-6 py-3 text-sm font-semibold text-neutral-0 transition-colors hover:bg-neutral-80'
        >
          Next Question
